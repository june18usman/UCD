...
write_xlsx(df, "A3_FPCA_RF_RS14.xlsx")
...
# Load Model Output
CR_A3_FPCA_RF_RS <- read_excel("A3_FPCA_RF_RS14.xlsx") 
CR_A3_FPCA_RF_RS$Observed_Outcome <- as.numeric(CR_A3_FPCA_RF_RS$Observed_Outcome)
CR_A3_FPCA_RF_RS <- CR_A3_FPCA_RF_RS %>% select(Observed_Outcome, Predicted_Probabilities)
names(CR_A3_FPCA_RF_RS) <- c("event", "predicted")

# Open a PNG device to save the plot
png(filename = "C_A3_FPCA_RF_RS.png", width = 800, height = 600)
# Generate and display the calibration plot
calibration_plot <- print_calibration_plot(CR_A3_FPCA_RF_RS, bins = 15)
