...
write_xlsx(df, "A2_PCA_KNN_RS8.xlsx")
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Load Model Output
CR_A2_PCA_KNN_RS <- read_excel("A2_PCA_KNN_RS8.xlsx")
CR_A2_PCA_KNN_RS$Observed_Outcome <- as.numeric(CR_A2_PCA_KNN_RS$Observed_Outcome)
CR_A2_PCA_KNN_RS <- CR_A2_PCA_KNN_RS %>% select(Observed_Outcome, Predicted_Probabilities)
names(CR_A2_PCA_KNN_RS) <- c("event", "predicted")

# Open a PNG device to save the plot
png(filename = "C_A2_PCA_KNN_RS.png", width = 800, height = 600)
# Generate and display the calibration plot
calibration_plot <- print_calibration_plot(CR_A2_PCA_KNN_RS, bins = 15)
