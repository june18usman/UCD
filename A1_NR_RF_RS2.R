#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Title - Approach 1: Random Forest without reduction [N-Fold]
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# Step 3: Set Up N Fold validation with Performance Metrics Storage.
...
AllCowsData_NRX <- AllCowsDataX[, 2:ncol(AllCowsDataX)]   
...
write_xlsx(df, "A1_NR_RF_RS2.xlsx")
...
CR_A1_NR_RF_RS <- read_excel("A1_NR_RF_RS2.xlsx") 
CR_A1_NR_RF_RS$Observed_Outcome <- as.numeric(CR_A1_NR_RF_RS$Observed_Outcome)
CR_A1_NR_RF_RS <- CR_A1_NR_RF_RS %>% select(Observed_Outcome, Predicted_Probabilities)
names(CR_A1_NR_RF_RS) <- c("event", "predicted")

# Open a PNG device to save the plot
png(filename = "C_A1_NR_RF_RS.png", width = 800, height = 600)
# Generate and display the calibration plot
calibration_plot <- print_calibration_plot(CR_A1_NR_RF_RS, bins = 10)
